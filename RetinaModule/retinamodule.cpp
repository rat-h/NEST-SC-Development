...
mynest::RetinaModule retinamodule_LTX_mod;

// -- DynModule functions ------------------------------------------------------

mynest::RetinaModule::RetinaModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::RetinaModule::commandstring( void ) const
{
  // Instruct the interpreter to load retinamodule-init.sli
